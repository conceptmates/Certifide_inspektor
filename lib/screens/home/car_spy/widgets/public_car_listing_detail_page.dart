            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _kv('ID', _str(l.id)),
                  _kv('User ID', _str(l.userId)),
                  _kv('Type', _str(l.type)),
                  _kv('Vehicle model ID', _str(l.vehicleModelId)),
                  _kv('Status', _str(l.status)),
                  ...
                  _kv('Created at', _str(l.createdAt)),
                  _kv('Updated at', _str(l.updatedAt)),
                  _kv('Deleted at', _str(l.deletedAt)),
